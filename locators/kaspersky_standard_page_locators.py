...
class StandardPageBuyBlockLocators:
    STANDARD_BUY_BLOCK_SELECTION = By.XPATH, \
        '//div[contains(@class, "Value") and @data-at-selector="select-value"]'
    ...
    STANDARD_BUY_BLOCK_CONTENT_WITH_DISCOUNT = By.XPATH, '(//div[@data-at-selector="current-price-container" \
    and @data-at-device-count="1" and @data-at-device-period="1"]//span[@data-hidden])[2]'
    STANDARD_BUY_BLOCK_CONTENT_WITHOUT_DISCOUNT = By.XPATH, '(//div[@data-at-selector="current-price-container" \
    and @data-at-device-count="1" and @data-at-device-period="1"]//span[@data-hidden])[1]'
...
class OpenBuyBlockLocators:
    STANDARD_DROPDOWN_LIST_SELECT = By.XPATH, \
