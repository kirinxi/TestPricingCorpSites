...
class StandardPriceList:
    ...
    standard_1d1y: str = None
    standard_1d1y_renewal: str = None
    standard_3d1y: str = None
    standard_3d1y_renewal: str = None
    standard_5d1y: str = None
    standard_5d1y_renewal: str = None
    standard_1d2y: str = None
    standard_1d2y_renewal: str = None

def generate_price():
    file = open("price.json")
    result = json.load(file)
    #print(result["standard_1d1y"])
    return StandardPriceList(
        standard_1d1y = result["standard_1d1y"],
        standard_1d1y_renewal = result["standard_1d1y_renewal"],
        standard_3d1y = result["standard_3d1y"],
        standard_3d1y_renewal = result["standard_3d1y_renewal"]),
        standard_5d1y = result["standard_3d1y"],
        standard_3d1y_renewal = result["standard_3d1y_renewal"])

print(generate_price().standard_1d1y)
